...
```bash
/Applications/APT\\ 2025.7.2/bin/apt
```
...
apt_command = '/Applications/APT\\ 2025.7.2/bin/apt'
...
```bash
/home/user/ast/apt/APT_2025.7.2/APT
```
...
# Path to APT executable:
apt_command = '/home/user/ast/apt/APT_2025.7.2/APT'
...
```bash
export APT='/Applications/APT\ 2025.7.2/bin/apt'
```
