...
```bash
/Applications/APT\\ 2026.3.2/bin/apt
```
...
# KNOWN_PROGRAMS is a list containing all known TSO PIDs up to cycle 5


# Path to APT executable:
apt_command = '/Applications/APT\\ 2026.3.2/bin/apt'
...
```bash
/home/user/ast/apt/APT_2026.3.2/APT
```
...
# Path to APT executable:
apt_command = '/home/user/ast/apt/APT_2026.3.2/bin/APT'
...
```bash
export APT='/Applications/APT\ 2026.3.2/bin/APT'
```
