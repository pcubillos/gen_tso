...
The `pandeia` python package, you will need to download the respective
(1) [reference
data](https://stsci.box.com/v/pandeia-data-v2026p7-jwst) and (2)
[PSF](https://stsci.box.com/v/pandeia-psfs-v2026p7-jwst) files.
...
/home/USERNAME/data/.../pandeia_data-2026.7-jwst

echo $PSF_DIR
/home/USERNAME/data/.../pandeia_psfs-2026.7-jwst
