...
<span style="font-size: 1.2em; font-weight: bold; color: #1a73e8;">
Gen TSO is up to date with Pandeia version 2026.7 (cycle 6) 🎉
</span>
:::
...
<details>
<summary>Click to expand command-line documentation</summary>
...
<table style="background-color: #f5f5f5; border-collapse: collapse; width: 100%;">
  ...
  <tbody>
    <tr>
        <td rowspan="3"><span data-qmd="__miri__"></span></td>
        <td>lrsslitless</td> <td>5.0 &#8211; 12.5</td>
    </tr>
    <tr>
        <td>lrsslit</td> <td>5.0 &#8211; 12.5</td>
    </tr>
    <tr>
